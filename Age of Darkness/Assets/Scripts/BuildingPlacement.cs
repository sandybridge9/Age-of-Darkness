...
{
    private Building currentBuildingProperties; //Used to detect if there is already a building in place
    ...
    public void SetItem(GameObject b)
    {
        ...
        currentBuildingProperties = currentBuilding.GetComponent<Building>();
    }
}
